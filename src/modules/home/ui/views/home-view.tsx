...
export const HomeView = () => {
  ...
  return (
    ...
    <div className="relative flex flex-col items-center justify-center h-full w-full overflow-hidden bg-gradient-to-br from-indigo-900 via-purple-900 to-black">
      ...
      {/* Connex.AI Logo Watermark Background */}
      <img
        src="/logo1.png" // 👈 apna logo path (public folder me rakhna)
        alt="Connex.AI Logo"
        className="absolute inset-0 m-auto w-[60%] opacity-10 pointer-events-none select-none"
      />
